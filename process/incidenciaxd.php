<?php
    ...
    <button class="botonessala" OnClick="location.href='../view/control_sala.php'">Volver al panel de control</button>  <button class="botonessala" OnClick="location.href='../process/logout.proc.php'">Logout</button>
        <br> <br>
      ...
      <div class="modal-content">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="tdinci"><button><a class="btnmodif" href= "../view/actualizar.php?id_incidencia=<?php echo $registro['id_incidencia']?>" onclick="return confirm('¿Estás seguro de actualizar?')">Modificar</a></button></td>
            </tr>
            <?php } ?>
        </table>
        <script>
